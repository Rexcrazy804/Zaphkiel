  ...
  Variants {
    ...
    delegate: Component {
      ...
      Rectangle {
        ...
        property int expandedHeight: 15
        ...
        Anim.SmoothIncreaseBehaviour on width { duration:150; easing: Easing.InOutCubic }
        Anim.SmoothIncreaseBehaviour on height { duration: 150; easing: Easing.Linear }

        Text {
          anchors.centerIn: parent
          visible: notchRect.height >= 15
          color: Ass.Colors.on_background
