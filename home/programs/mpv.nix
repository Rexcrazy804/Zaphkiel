{
  ...
  in {
    ...
    bindings = { # shaders BABY [Anime4k Upscaller]
      ...
      "CTRL+2" = "no-osd change-list glsl-shaders set \"" + builtins.concatStringsSep ":" [
        "${shaderFolder}/Anime4K_Clamp_Highlights.glsl"
      ...
      "CTRL+3" =  "no-osd change-list glsl-shaders set \"" + builtins.concatStringsSep ":" [
        "${shaderFolder}/Anime4K_Clamp_Highlights.glsl"
      ...
      "CTRL+4" =  "no-osd change-list glsl-shaders set \"" + builtins.concatStringsSep ":" [
        "${shaderFolder}/Anime4K_Clamp_Highlights.glsl"
        "${shaderFolder}/Anime4K_Restore_CNN_VL.glsl"
        "${shaderFolder}/Anime4K_Upscale_CNN_x2_VL.glsl"
      ...
      "CTRL+5" = "no-osd change-list glsl-shaders set \"" + builtins.concatStringsSep ":" [ 
        "${shaderFolder}/Anime4K_Clamp_Highlights.glsl"
        "${shaderFolder}/Anime4K_Restore_CNN_Soft_VL.glsl"
        "${shaderFolder}/Anime4K_Upscale_CNN_x2_VL.glsl"
        "${shaderFolder}/Anime4K_AutoDownscalePre_x2.glsl"
      ...
      "CTRL+6" = "no-osd change-list glsl-shaders set \"" + builtins.concatStringsSep ":" [
        "${shaderFolder}/Anime4K_Clamp_Highlights.glsl"
        "${shaderFolder}/Anime4K_Upscale_Denoise_CNN_x2_VL.glsl"
        "${shaderFolder}/Anime4K_AutoDownscalePre_x2.glsl"
        "${shaderFolder}/Anime4K_AutoDownscalePre_x4.glsl"
